...
Github: [https://github.com/imzsh/HugoFast](https://github.com/imzsh/HugoFast)  
...
前往 [https://github.com/imzsh/HugoFast](https://github.com/imzsh/HugoFast) fork 本项目，然后下载到本地。

```bash
git clone https://github.com/imzsh/HugoFast.git
```
