...
![](https://imgurl.s3.bitiful.net/images/2021/05/09/49e7bb85ed4228bb7811bf78f79878d0.png)

阿里云：[https://developer.aliyun.com/plan/grow-up](https://developer.aliyun.com/plan/grow-up)

![](https://imgurl.s3.bitiful.net/images/2021/05/09/4f77bef832af425c57bbab74075bad78.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/8857ba9becbbb51df2256bd0cf6acbd3.png)

阿里云：[https://wanwang.aliyun.com/domain](https://wanwang.aliyun.com/domain)

![](https://imgurl.s3.bitiful.net/images/2021/05/11/28dea75217501fa6090df5374a994608.png)

华为云：[https://activity.huaweicloud.com/domain1.html](https://activity.huaweicloud.com/domain1.html)

![](https://imgurl.s3.bitiful.net/images/2021/05/11/545398ef8ec2147e76d06536ac1bc62a.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/8c9554cec2f765f559c272a6ac360d6b.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/e556f7143c95278a969612242a46ebae.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/c1a01ea7140e5669dd2a039fe5ef81b5.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/9f0adbe007c866d5f99d7aecc811c0dd.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/80adff2edec40d09eac4a104b1fd2b0a.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/cdfd81118b588eb1591281b9fda9c115.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/3d4ae9731d4c32a7d828e3c4d6218ef9.png)

这里可以先设置一下站点，点击站点右侧的设置，需要设置的有伪静态，SSL证书，，，

伪静态选择typecho，然后保存。

![](https://imgurl.s3.bitiful.net/images/2021/05/11/bb5a833133b91a2bcb05fe7c8ad07f97.png)

SSL证书，选择宝塔SSL证书，申请证书，填写相关信息，提交资料等申请成功就可以了。

![](https://imgurl.s3.bitiful.net/images/2021/05/11/63078aa08ab79cd588722a625640bc55.png)

![](https://imgurl.s3.bitiful.net/images/2021/05/11/98cecc20651ad2aa9056965a4004c2a6.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/4764539572826852ef33d9f4f1b4737f.png)


点击上传，弹出窗口，点击上传文件，找到下载的Typecho压缩包，打开，然后开始上传，上传完毕关闭窗口。

![](https://imgurl.s3.bitiful.net/images/2021/05/11/019bdf158e1ff508e71662e2ef06bda8.png)

![](https://imgurl.s3.bitiful.net/images/2021/05/11/38a903132952557ffce43ff3d11999c4.png)

解压该压缩包后（删除压缩包），得到build文件夹，进入其文件夹内，选择文件名旁边的框，全选文件，右上角选择剪贴，然后回到上一级根目录下，黏贴，然后删掉没用的build文件夹就可以了。

![](https://imgurl.s3.bitiful.net/images/2021/05/11/7bfe1bcbc959ee73c9869bf11ab950d6.png)

![](https://imgurl.s3.bitiful.net/images/2021/05/11/ea2c1bc80de015657cf1fad157df5274.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/f82fb90632987b1cdaddb583e4534664.png)

点击下一步，进入初始化配置，这一步需要填写修改的是数据库用户名（添加站点时设置的数据库账号，如果忘了可去宝塔面板页面左侧，数据库查看），数据库密码，数据库名（数据库名和数据库用户名是一样的！），用户名，登录密码，邮件地址，确认，开始安装。

![](https://imgurl.s3.bitiful.net/images/2021/05/11/0d5e93682c1ec6e5d0b441d49bf28618.png)

不出意外，安装成功！

![](https://imgurl.s3.bitiful.net/images/2021/05/11/f9c0d8bae2e1f5d652774332a986a3ea.png)

现在再浏览器访问域名，便可以查看你的Typecho博客了，当然现在是默认主题，还是比较丑的。

去百度你喜欢的主题下载，然后上传根目录/usr/themes/目录里面，在后台外观设置中更换。各主题教程以及配置教程都有主题文档。

![](https://imgurl.s3.bitiful.net/images/2021/05/11/8a851580aaff42f50f52703898b66d6b.png)

插件安装是将下载的插件上传根目录/usr/plugin/ 目录里面，在后台设置中启用插件，设置插件。

![](https://imgurl.s3.bitiful.net/images/2021/05/11/316748ca1a877075d9e0d50ee0775d9e.png)
...
![](https://imgurl.s3.bitiful.net/images/2021/05/11/bc2528e7c7fa51abd06530cd16cc3b7a.png)
