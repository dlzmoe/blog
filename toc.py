...
def process_md_files(folder_path):
    ...
    for md_file in md_files:
        ...
        # 将格式化的文本添加到输出列表中
        if slug is not None:
            output_text.append(f'- {file_name} 【[GitHub 文件链接](./content/blog/{file_name}.md) / [博客链接](https://zishu.me/blog/{slug}.html/)】')
            # output_text.append(f'- [{file_name}](./content/blog/{file_name}.md) --- [https://zishu.me/blog/{slug}.html](https://zishu.me/blog/{slug}.html/)')
